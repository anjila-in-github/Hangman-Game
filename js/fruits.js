...
const displayOptions = () => {
    optionsContainer.innerHTML += `<h3>Guess <h2>FRUITS</h2><h3> If You DARE <i class="fa fa-skull"></i> !</h3></h3>`;
...
const generateWord = (optionValue) => {
    ...
    var hints = [
        ...
        "Eaten when its green or yellow",
        "Is red in color",
        "It's name represents a color",
        "Ends with apple",
        "Similar to apple",
        "Ends with each",
        "Eaten when its yellow"
    ];
