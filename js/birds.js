...
const displayOptions = () => {
    optionsContainer.innerHTML += `<h3>Guess <h2>BIRDS</h2><h3> If You DARE <i class="fa fa-skull"></i> !</h3></h3>`;
...
const generateWord = (optionValue) => {
    ...
    var hints = [
        ...
        "Bird that eats fish",
        "Largest Bird",
        "A bird whose name also represents country",
        "Is pink in color"
    ];
