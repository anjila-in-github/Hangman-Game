...
const displayOptions = () => {
    optionsContainer.innerHTML += `<h3>Guess <h2>DOMESTIC ANIMALS</h2><h3> If You DARE <i class="fa fa-skull"></i> !</h3></h3>`;
...
const generateWord = (optionValue) => {
    ...
    var hints = [
        ...
        "Similar as sheep",
        "As similar as goat",
        "Commonly raised for meet(beef)",
        "Also known as bunny",
        "Have short tail long slim leg",
        "Also called as swine",
        "Animal that people ride on"
    ];
