...
const displayOptions = () => {
    optionsContainer.innerHTML += `<h3>Guess <h2>STATIONARY ITEMS</h2><h3> If You DARE <i class="fa fa-skull"></i> !</h3></h3>`;
...
const generateWord = (optionValue) => {
    ...
    var hints = [
        ...
        "Use metal nib to apply ink",
        "A form of tube that contain solid stick",
        "Used for filing document",
        "Container used to store pencil",
        "Handheld device for imprinting",
        "Pen having a tiny  metal ball",
        "Synonym:wafer-thin",
        "A felt-tip pen",
        "Holds papers together for organization and protection"
    ];
