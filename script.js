        ...
        for(let i =65;i<91;i++){
            ...
            button.addEventListener("click",()=>{
                ...
                if(charArray.includes(button.innerText)){
                    charArray.forEach(char,index) => {
                        ...
                        if(char ===button.innerText){
                            ...
                            if(winCount==charArray.length){
                                ...
                                classs<='win-msg'>You Win!!</span></p>The word was <span>${choosenword}</span></p>';
                                //block all buttons
                                blocker();
                            }
                        }
                 ...
                 if(count==6){
                        resultText.innerHTML='<h2 class='lose-msg'>YouLose!!</h2><p>The word was <span>${choosenword}</span></p>';
                        blocker();
                    }
                }
